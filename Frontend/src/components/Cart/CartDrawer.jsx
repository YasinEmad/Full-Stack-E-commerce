...
const CartDrawer = () => {
  ...
  return (
    <div className="fixed top-0 right-0 h-full w-full sm:w-96 bg-white shadow-lg z-50 transform transition-transform ease-in-out duration-300">
      ...
      <div className="absolute bottom-0 left-0 w-full p-4 border-t border-gray-200 bg-white">
        ...
        <button
          className="w-full bg-indigo-600 text-white py-3 px-4 rounded-md text-lg font-semibold hover:bg-indigo-700 transition duration-200"
        >
          Buy Now
        </button>
        <button
