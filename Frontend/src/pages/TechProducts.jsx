...
const TechProducts = () => {
  ...
  <p className="text-gray-600 text-lg">
    Explore our exclusive range of tech styles designed for enthusiasts and
    professionals alike.
  </p>
</div>
 ...
 {/* Products Grid */}
        {filteredCount === 0 ? (
          <div className="text-center py-16">
            ...
            </p> {/* <-- This was </Next>, now it's correct */}
            <button
              onClick={clearFilters} // 🚀 Use hook function
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            {filtered.map((product) => (
              ...
              >
                ...
                {/* Content Area (with flex-col to push buttons) */}
                <div className="p-5 flex flex-col flex-1">
                  {/* Main info wrapper (this part grows) */}
